...
function FormEliminarProducto() {
  ...
  const manejarEliminar = () => {
    const confirmar = window.confirm(
      `¿Estás seguro de que deseas eliminar el producto "${producto.producto}"?\n\nEsta acción no se puede deshacer.`
    );
    ...
    //  navigate('/productos');
     setTimeout(() => {
      ...
      alert(`(EN FormEliminarProducto) \n Hubo un problema al eliminar el producto ${producto.producto}.`);
    } finally {
      setCargando(false);
    }
    }
